...
var _ = Describe("testing enable TCP Reset for load balancer PUT", func() {
	It("should pass for standard LB with correct api version", func() {
	...
	It("should skip if resource type is not load balancer", func() {
		...
		{
			"etag":"W/\"2e1cb000-775f-4fa7-988a-d5e4c8db4fe1\"",
			"id":"/subscriptions/subId1/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/network1",
			"location":"westus2",
			"name":"rg1",
			"properties":{
				"addressSpace": {
		...
		output, err := enableTCPReset(
			"PUT",
			"/subscriptions/subId1/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/network1?api-version=2018-07-01",
			"2018-07-01",
			[]byte(inputLoadBalancerBody))
		...
		output, err = enableTCPReset(
			"PUT",
			"/subscriptions/subId1/resourceGroups/rg1?api-version=2018-07-01",
			"2018-07-01",
			[]byte(inputLoadBalancerBody))
	...
	It("should pass for standard LB without resource type", func() {
